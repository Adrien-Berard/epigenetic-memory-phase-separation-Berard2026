"""
Contact map analysis — per cell-cycle-phase Hi-C maps.
Outputs one Hi-C figure per phase (G1, G2, M) averaged across all frames
belonging to that phase, with a shared colorbar for direct comparison.
"""
