...
src_fig7.py
----------
Build Figure 7: model panel, kymographs, Hi-C, and Epe1 nucleation snapshots.
"""
...
DUMP_FILES = [
    DATA_ROOT / "19_03_Sim" / "WihtoutEpe1" / "WithoutBE" / "dump.lammpstrj",
    DATA_ROOT / "19_03_Sim" / "WithEpe1" / "WithoutBE" / "dump.lammpstrj",
    DATA_ROOT / "19_03_Sim" / "WithEpe1" / "2or3Nuc" / "2_nucleation_sites" / "dump.lammpstrj",
    DATA_ROOT / "19_03_Sim" / "WithEpe1" / "2or3Nuc" / "3_nucleation_sites" / "dump.lammpstrj",
]
...
KYMO_CHIP_FILES = [
    DATA_ROOT / "19_03_Sim" / "WihtoutEpe1" / "WithoutBE" / "id_and_type.dat",
    DATA_ROOT / "19_03_Sim" / "WithEpe1" / "WithoutBE" / "id_and_type.dat",
    DATA_ROOT / "19_03_Sim" / "WithEpe1" / "2or3Nuc" / "2_nucleation_sites" / "id_and_type.dat",
    DATA_ROOT / "19_03_Sim" / "WithEpe1" / "2or3Nuc" / "3_nucleation_sites" / "id_and_type.dat",
]

# -- Snapshot image files for panels (a), (b), (e) ----------------------------
#    Provide paths to PNG/JPG images, or set to None to leave panel empty.
SNAPSHOT_A = DATA_ROOT / "19_03_Sim" / "Figure6a.pdf"   # e.g. DATA_ROOT / "snapshots" / "model1.png"
SNAPSHOT_B = DATA_ROOT / "19_03_Sim" / "Figure6b.pdf"   # e.g. DATA_ROOT / "snapshots" / "model2.png"
SNAPSHOT_E = DATA_ROOT / "19_03_Sim" / "epe1_snapshots.pdf"   # e.g. DATA_ROOT / "snapshots" / "overview.png"
