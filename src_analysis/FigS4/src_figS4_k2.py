...
src_figS4_k2.py
----------
Supplementary Figure S4 (k2): phase-diagram scan k2 vs Swi6; same pipeline as k1 with k2-specific legends.
"""
import os
...
# CONFIG
# ============================================================
CONDENSED_DIR = DATA_ROOT / "SPombe_MatRegion_Model" / "ParameterScanDifferentSwi6Differentp2-13-03-26-Revision"
DILUTE_DIR    = DATA_ROOT / "SPombe_MatRegion_Model" / "ParameterScanDifferentSwi6Differentp2-13-03-26-Revision"
OUTPUT_DIR    = DATA_ROOT / "SPombe_MatRegion_Model" / "GMM_PhaseDiagram" / "Fullp2vsswi6" / "13-03"
...
# OUTPUT_DIR    = DATA_ROOT / "SPombe_MatRegion_Model" / "GMM_PhaseDiagram" / "p1vsp2" / "finerScan" / "OtherRegion"
...
# X-axis and Y-axis parameter names (used for directory parsing and labels)
# Change these to match your directory naming convention, e.g. "p2"/"swi6"
X_PARAM = "p2"  # k2 (directory key)    # name of the parameter that varies along x-axis
