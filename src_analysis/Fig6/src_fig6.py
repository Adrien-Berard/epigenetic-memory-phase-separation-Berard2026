...
src_fig6.py
----------
Build Figure 6 two-polymer composite (model PDF, snapshots, contact maps).
"""
...
# ── FILE PATHS ─────────────────────────────────────────────────────────────────
Fixed_types_dat  = DATA_ROOT / "SPombe_MatRegion_Model" / "2PolymersPAPER" / "sim_p2_0.00025_noise_500_swi6_400_nuc_160Fixed" / "types1.dat"
Diffusive_types_dat  = DATA_ROOT / "SPombe_MatRegion_Model" / "2PolymersPAPER" / "sim_p2_0.00025_noise_500_swi6_400_nuc_160" / "types1.dat"
Fixed_types_dump = DATA_ROOT / "SPombe_MatRegion_Model" / "2PolymersPAPER" / "sim_p2_0.00025_noise_500_swi6_400_nuc_160Fixed" / "dump.lammpstrj"
Diffusive_types_dump = DATA_ROOT / "SPombe_MatRegion_Model" / "2PolymersPAPER" / "sim_p2_0.00025_noise_500_swi6_400_nuc_160" / "dump.lammpstrj"

MODEL_PDF = DATA_ROOT / "SPombe_MatRegion_Model" / "2PolymersPAPER" / "model_2poly.pdf"

SNAPSHOT_FIXED_PRE     = DATA_ROOT / "SPombe_MatRegion_Model" / "2PolymersPAPER" / "sim_p2_0.00025_noise_500_swi6_400_nuc_160Fixed" / "fixed_2poy_pre.png"
SNAPSHOT_FIXED_MEETING = DATA_ROOT / "SPombe_MatRegion_Model" / "2PolymersPAPER" / "sim_p2_0.00025_noise_500_swi6_400_nuc_160Fixed" / "fixed_2poy_meeting.png"
SNAPSHOT_FIXED_POST    = DATA_ROOT / "SPombe_MatRegion_Model" / "2PolymersPAPER" / "sim_p2_0.00025_noise_500_swi6_400_nuc_160Fixed" / "fixed_2poy_post.png"

SNAPSHOT_DIFF_PRE      = DATA_ROOT / "SPombe_MatRegion_Model" / "2PolymersPAPER" / "sim_p2_0.00025_noise_500_swi6_400_nuc_160" / "diffusive_2poy_pre.png"
SNAPSHOT_DIFF_MEETING  = DATA_ROOT / "SPombe_MatRegion_Model" / "2PolymersPAPER" / "sim_p2_0.00025_noise_500_swi6_400_nuc_160" / "diffusive_2poy_meeting.png"
SNAPSHOT_DIFF_POST     = DATA_ROOT / "SPombe_MatRegion_Model" / "2PolymersPAPER" / "sim_p2_0.00025_noise_500_swi6_400_nuc_160" / "diffusive_2poy_post.png"
...
def draw_image(ax, img, title="", letter=None,aspect='equal'):
    ...
    if letter:
        ax.text(-0.04, 0.98, letter, transform=ax.transAxes,
                fontsize=MPL_RC["axes.titlesize"],
                va="bottom", ha="right")
...
def draw_hic(ax, avg_mat, title="", cbar=False, vmin=-4, vmax=0):
    ...
    ax.set_xlabel("Nucleosome position", fontsize=MPL_RC["axes.labelsize"])
    ax.set_ylabel("Nucleosome\nposition", fontsize=MPL_RC["axes.labelsize"])
...
def draw_types_timeseries(ax, timesteps, types_df, title=""):
    ...
    ax.set_xlabel(r"Time ($\tau_{LJ}$)", fontsize=MPL_RC["axes.labelsize"],labelpad = 3)
    ax.set_xticks([0, 5e7, 10e7, 15e7], ["0", "5", "10", rf"$15 \times 10^4$"])
    ax.set_ylabel("Count\n nucleosomal \n type", fontsize=MPL_RC["axes.labelsize"])
...
def make_figure(cutoff=CONTACT_CUTOFF, n_avg=N_FRAMES_AVG, outfile=None):
    ...
    # ax_model.set_title("Model", fontsize=MPL_RC["axes.titlesize"], pad=4)
    ...
    # ── Save / show ────────────────────────────────────────────────────────
    if outfile:
        fig.savefig(outfile, dpi=MPL_RC["savefig.dpi"], bbox_inches="tight")
