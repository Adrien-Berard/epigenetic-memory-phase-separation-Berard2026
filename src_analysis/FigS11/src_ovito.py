...
N_CHROMATIN    = 500          # fixed chain length — set this manually
...
vp.render_image(filename='full_view_3nuc.png', size=(1600, 1200),
                frame=500000, renderer=renderer_image, alpha=False)
...
# vp.render_anim(filename='3nuc_rep_movie_full.mp4', size=(600, 600), fps=50,
#                 every_nth=500, renderer=renderer_video)
vp.render_anim(filename='3nuc_rep_movie_full_better.mp4', size=(1200, 1200), fps=20,
                every_nth=50, renderer=renderer_video)
