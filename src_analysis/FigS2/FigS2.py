"""
DuplicateFig.py  (PRX Life style)
----------------
...
Panel order (top → bottom), all sharing the same x-axis:
  ...
  (a)  Kymograph            (dump, stacked)
  (b)  Polymer type counts  A/U/M  (one per polymer, from dump)
  (c)  Swi6M count          (types1.dat, green)
  (d)  Rg                   (r2.dat col c_R2[0], grey)
