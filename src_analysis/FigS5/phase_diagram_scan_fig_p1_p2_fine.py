...
# CONDENSED_DIR = '/home/adrien/SPombe_MatRegion_Model/P1_P2_scan_swi6_400'
# DILUTE_DIR    = '/home/adrien/SPombe_MatRegion_Model/P1_P2_scan_swi6_400'
# OUTPUT_DIR    = "/home/adrien/SPombe_MatRegion_Model/GMM_PhaseDiagram/p1vsp2/try"
...
OUTPUT_DIR    = "/home/adrien/SPombe_MatRegion_Model/GMM_PhaseDiagram/p1vsp2/finer"
...
def plot_phase_diagrams(all_fhA, all_fhM, noise_values,
    ...
    panel = fig.add_axes([0.68, 0.15, 0.16, 1])
    panel.axis("off")
...
def run(dilute_dir, condensed_dir, output_dir, noise_values,
    ...
    with open(csv_path, mode="w", newline="") as f:
        writer = csv.writer(f)
        writer.writerow(["noise", x_param, y_param, "all_tauA_both", "all_tauM_both"])
    ...
    # ============================================================
    pdf_path = os.path.join(output_dir, "time_frac_phase_diagrams_FINER_p1_p2_scan_swi6_400.pdf")
    ...
    x_param,
    y_param,
    "time_frac_phase_diagrams_finer_p1p2.svg",
)
