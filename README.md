...
Analysis code and interactive mean-field demo accompanying **Berard et al. (PRX Life, 2026)** [https://doi.org/10.1103/pbvj-gj48](https://doi.org/10.1103/pbvj-gj48).

Simulation trajectories and scan outputs are **not stored in this repository**. Download the datasets from **Zenodo** ([https://doi.org/10.5281/zenodo.16911423](https://doi.org/10.5281/zenodo.16911423)) and set `BERARD_DATA_ROOT` to the unpacked folder, or place files under `./data/` following the layout described on Zenodo.
...
| **FigS6**  | `[src_figS6.py](src_analysis/FigS6/src_figS6.py)`                                                                                  | DNA-replication and cell-cycle kymographs.                                                       |
| **FigS7**  | `[src_figS7.py](src_analysis/FigS7/src_figS7.py)`                                                                                  | Switching-polymers time series                                                                   |
|            | `[src_videos.py](src_analysis/FigS7/src_videos.py)`                                                                                | Batch OVITO video driver                                                                         |
| **FigS8**  | `[src_figS8.py](src_analysis/FigS8/src_figS8.py)`                                                                                  | Diffusive two-polymer supplementary composite                                                    |
| **FigS9**  | `[src_figS9.py](src_analysis/FigS9/src_figS9.py)`                                                                                  | Swi6* local concentration and CoM distance.                                                      |
...
Berard et al., *Epigenetic memory achieved through chromatin-induced phase separation* (PRX Life, 2026) [https://doi.org/10.1103/pbvj-gj48](https://doi.org/10.1103/pbvj-gj48).  
*(Full bibliographic entry and Zenodo DOI ([https://doi.org/10.5281/zenodo.16911423](https://doi.org/10.5281/zenodo.16911423)))*
